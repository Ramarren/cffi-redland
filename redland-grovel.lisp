...
(cenum log-facility
       ((:none "LIBRDF_FROM_NONE"))
       ((:concepts "LIBRDF_FROM_CONCEPTS"))
       ((:digest "LIBRDF_FROM_DIGEST"))
       ((:files "LIBRDF_FROM_FILES"))
       ((:hash "LIBRDF_FROM_HASH"))
       ((:init "LIBRDF_FROM_INIT"))
       ((:iterator "LIBRDF_FROM_ITERATOR"))
       ((:list "LIBRDF_FROM_LIST"))
       ((:model "LIBRDF_FROM_MODEL"))
       ((:node "LIBRDF_FROM_NODE"))
       ((:parser "LIBRDF_FROM_PARSER"))
       ((:query "LIBRDF_FROM_QUERY"))
       ((:serializer "LIBRDF_FROM_SERIALIZER"))
       ((:statement "LIBRDF_FROM_STATEMENT"))
       ((:storage "LIBRDF_FROM_STORAGE"))
       ((:stream "LIBRDF_FROM_STREAM"))
       ((:uri "LIBRDF_FROM_URI"))
       ((:utf8 "LIBRDF_FROM_UTF8"))
       ((:memory "LIBRDF_FROM_MEMORY"))
       ((:last "LIBRDF_FROM_LAST")))
